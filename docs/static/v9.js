...
const createFlexBox = (defaultProps = {})=>/*#__PURE__*/ forwardRef((props, ref)=>{
        ...
        const mapped = mapFlexProps({
            ...defaultProps,
            ...props
        }, ref, "Box");
        return /*#__PURE__*/ jsx(MuiBox, {
            ...unstable_extendSxProp(mapped)
        });
    });
...
const createFlexGrid = (defaultProps = {})=>/*#__PURE__*/ forwardRef((props, ref)=>{
        // MUI v9 removed system props from Grid; fold them into sx instead.
        const mapped = mapFlexProps(verifyGridSizeProps({
            ...defaultProps,
            ...props
        }, "new"), ref, "Grid2");
