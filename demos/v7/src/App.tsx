...
const App = () => {
  ...
  ...
        ...
        <FlexGrid2 container component={"section" as any} spacing={[0.5, 1, 2]} sx={{ maxWidth: "100%" }}>
          <FlexGrid2 size={12} component={"header" as any}>
            <Typography component="h2" variant="h5">
        ...
        <FlexBox component={"section" as any} column sx={{ width: "100%", maxWidth: "100%", rowGap: [2, 3, 4] }}>
        ...
        <FlexBox component={"section" as any} column sx={{ width: "100%", maxWidth: "100%", rowGap: [2, 3, 4] }}>
          <FlexGrid2 container spacing={[0.5, 1, 2]} sx={{ maxWidth: "100%" }}>
            <FlexGrid2 size={12} component={"header" as any} ref={ref}>
              <Typography component="h2" variant="h5">
                Ref test
              </Typography>
            </FlexGrid2>
