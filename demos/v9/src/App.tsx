...
// @ts-ignore
import packageJson from "../../../packages/v9/package.json";
import {
  BasicGridTitle,
  ColumnBasicTitle,
  columnCombinations,
    ...
    <ThemeProvider theme={theme}>
      ...
      <FlexBox width="100vw" p={[2, 3, 4]} gap={[1, 2, 2]} x="center" component="main" sx={{ bgcolor: "#fff" }} column>
        <FlexBox x="left" y="center" column>
          <DemoTitle packageName={`mui-flexy v${packageJson.version}`} muiVersion="9" FlexBox={FlexBox} />
