...
import { type InferFlexProps, type ResponsiveFlexBoolean, ResponsiveFlexDirection, ResponsiveFlexPosition } from "./Flex.types";
type _Any = any;
...
export declare const mapFlexProps: <P extends MappableFlexProps = MappableFlexProps>(props: P, ref?: React.Ref<_Any> | null, componentName?: "Box" | "Grid" | "Grid2") => P;
