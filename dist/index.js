...
// UNUSED EXPORTS: FlexBox, FlexGrid
...
;// CONCATENATED MODULE: ./src/Flex.utils.ts
...
var mapAlignment = function mapAlignment(alignment) {
  if (!alignment) return;
  if (typeof alignment === "string") {
    ...
    return Object.fromEntries(Object.entries(alignment).map(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
        k = _ref2[0],
        a = _ref2[1];
      return [k, mapAlignment(a)];
    }));
  }
};
var mapDirection = function mapDirection(direction) {
  var reverse = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  if (!direction) return "row";
  if (typeof direction === "string") {
    if (!["row", "row-reverse", "column", "column-reverse"].includes(direction)) {
      console.warn("Using { flex-direction: ".concat(direction, " } with mui-flex shorthand is not recommended because it can cause unexpected alignment and orientation anomalies."));
    }
    switch (direction) {
      case "row":
      case "column":
    ...
    return Object.fromEntries(Object.entries(direction).map(function (_ref3) {
      var _ref4 = _slicedToArray(_ref3, 2),
        k = _ref4[0],
        d = _ref4[1];
      return [k, mapDirection(d, reverse)];
    }));
  }
};
...
var mapResponsiveObject = function mapResponsiveObject(direction, main, cross) {
  return Object.fromEntries(Object.entries(direction).map(function (_ref5) {
    ...
    if (d.startsWith("column")) {
      var _mapAlignment;
      return [key, typeof cross === "string" ? cross : (_mapAlignment = mapAlignment(cross)) === null || _mapAlignment === void 0 ? void 0 : _mapAlignment[key]];
    } else {
      var _mapAlignment2;
      return [key, typeof main === "string" ? main : (_mapAlignment2 = mapAlignment(main)) === null || _mapAlignment2 === void 0 ? void 0 : _mapAlignment2[key]];
    }
  }));
};
var mapFlexProps = function mapFlexProps(props) {
  var x = props.x,
    y = props.y,
    row = props.row,
    column = props.column,
    ...
    nowrap = props.nowrap;
  var direction = mapDirection(row ? "row" : column ? "column" : flexDirection, reverse);
  ...
  if (typeof direction === "string") {
    ...
    if (Array.isArray(x) && x.length !== direction.length && typeof x !== "string" || Array.isArray(y) && y.length !== direction.length && typeof y !== "string") {
      throw new Error("Invalid flex shorthand props. If using ResponsiveStyleValue arrays for x, y, or flexDirection,\
 all arrays must be the same length. You may only mix and match ResponsiveStyleValue arrays and strings.");
  ...
  } else if (direction && _typeof(direction) === "object") {
    if (_typeof(x) !== "object" && typeof x !== "string" || _typeof(y) !== "object" && typeof y !== "string") {
      throw new Error("Invalid flex shorthand props. You may only mix and match ResponsiveStyleValue objects and strings.");
    }
    return _objectSpread(_objectSpread({}, flexProps), {}, {
      flexDirection: direction,
...
var _test = {
  ...
  mapFlexProps: mapFlexProps
};
;// CONCATENATED MODULE: ./src/Flex.tsx
function Flex_typeof(obj) { "@babel/helpers - typeof"; return Flex_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, Flex_typeof(obj); }
var Flex_excluded = ["x", "y", "row", "column", "reverse", "nowrap"];
...
function Flex_defineProperty(obj, key, value) { key = Flex_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function Flex_toPropertyKey(arg) { var key = Flex_toPrimitive(arg, "string"); return Flex_typeof(key) === "symbol" ? key : String(key); }
function Flex_toPrimitive(input, hint) { if (Flex_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (Flex_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = Flex_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
...
var flex = function flex(Component, componentName) {
  var WC = /*#__PURE__*/(0,react.forwardRef)(function (props, ref) {
    var x = props.x,
      y = props.y,
      row = props.row,
      column = props.column,
      reverse = props.reverse,
      nowrap = props.nowrap,
      rest = _objectWithoutProperties(props, Flex_excluded);
    var flexProps = Flex_objectSpread(Flex_objectSpread({}, rest), mapFlexProps(props));
    var className = "".concat(props.className || "", " MuiFlex-root").concat(componentName ? " MuiFlex".concat(componentName, "-root") : "");
    return /*#__PURE__*/(0,jsx_runtime.jsx)(Component, Flex_objectSpread(Flex_objectSpread({}, flexProps), {}, {
      ref: ref,
      className: className
    }));
  });
  WC.displayName = "Flex(".concat(componentName !== null && componentName !== void 0 ? componentName : getDisplayName(Component), ")");
  return WC;
};
var FlexBox = flex(Box_Box, "Box");
var FlexGrid = flex(function (props) {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(FlexBox, Flex_objectSpread(Flex_objectSpread({}, props), {}, {
    component: Grid_Grid
  }));
}, "Grid");
