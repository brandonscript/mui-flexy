...
import type { FlexBoxColumnProps, FlexBoxProps, FlexBoxRowProps } from "@mui-flexy/v9";
import { FlexBox, FlexColumnBox, FlexRowBox } from "@mui-flexy/v9";

console.log("Tests running with MUI version:", muiVersion);

describe("Verify MUI version", () => {
  it("should be MUI version 9", () => {
    expect(muiVersion).toEqual(9);
  });
});
